...
@Disabled
@TeleOp(name="POV", group="Linear Opmode")
public class PurplePOV extends LinearOpMode {
    ...
    private boolean crawlSpeed = true;
    ...
    private void driveAction(){
        ...
        double leftPower = 0;
        double rightPower = 0;
        //if right bumper is pressed then toggle crawl speed
        ...
        //if y is pressed then toggle tank mode
        if (gamepad1.y) {
            if (tankMode) {
                tankMode = false;
            }
