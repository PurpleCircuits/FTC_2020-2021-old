...
public class SensorsTest extends LinearOpMode {
    ...
    BNO055IMU imu;
    private DigitalChannel digitalChannel = null;
    ...
    public void runOpMode() {
        ...
        telemetry.addData("Status", "Verify");
        telemetry.update();
        initHardware();
        ...
        if (digitalChannel.getState() == true) {
    ...
    private void initHardware() {
        ...
        //digitalChannel = hardwareMap.get(DigitalChannel.class, "slide_limit");
